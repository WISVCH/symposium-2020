...
export default () => (
    <Page>
        ...
        <H2>About Us</H2>
        <Text>Advanced Analytics: Diving Deep Into Your Data is organized by a team consisting of seven Mathematics and Computer Science students, all are in different stages of their studies. They work hand in hand to organize the symposium to the best of their abilities.</Text>
