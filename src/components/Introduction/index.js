...
const Introduction = () => (
  <div className="Introduction shadow accent row">
    ...
    <p>
      This October, we will present healthcare in the future.
      During this day, you will be enlightened by the academics who are currently pushing the boundaries in healthcare technology, improving health, bit by bit.<br />
      <br />
